...
<template>
    <section id="form">
        <div>
            ...
            <button @click="handleCloseModal" class="link-button"><i class="fa-solid fa-xmark"></i></button>
        </div>
        <div>
        ...
        <div>
            ...
            <input type="number" id="lifeExpectancy" max="120" required v-model="lifeExpectancy" />
        </div>
