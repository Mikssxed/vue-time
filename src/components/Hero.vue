<script setup>
const { name, data, handleToggleModal } = defineProps({ name: String, data: Object, handleToggleModal: Function })

</script>

<template>
    <section id="hero">
        <h3 class="text-large">{{ name }}, you have {{ data.weeks }} weeks left. Make them count.</h3>
